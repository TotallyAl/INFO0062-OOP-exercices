...
public abstract class Voter implements Runnable {
    ...
    public void chanceOfLeaveUpdate(double chanceOfLeave) {
        this.chanceOfLeave = chanceOfLeave;
    }

    public final void run() {
        place.welcome(this);
        place.recordVote(this);
         ...
         * -There's no synchronization mechanism here because println() is already a
         * "thread-safe"
         * method, i.e., it will no be executed by several threads at the same time.
         * This can be
         * checked by reviewing the source code of the JDK:
         *
         * http://hg.openjdk.java.net/jdk/jdk13/file/0368f3a073a9/src/java.base/share/
