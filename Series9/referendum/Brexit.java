...
public class Brexit {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < voters.length; i++) {
            /*
             * To simplify, we assume each category makes up around 1/3 of the population.
             * For
             * nextInt(), see here:
         ...
         * -To keep a result with one decimal, it is multiplied by a higher value than
         * necessary
         * then divided by a double value.
         * -Using the ".0" for this value matters, as it will implicitly convert the
         * division (of
